...
public class OzaoServerProtocol extends ServerProtocol {
    ...
    public OzaoServerProtocol(Function<Buffer, Buffer> compressFunction, Function<Buffer, Buffer> decompressFunction) {
